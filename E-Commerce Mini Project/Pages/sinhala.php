...
$category_name = 'sinhala'; // Change this if you use different category IDs
  ...
  <div class="wrapper grey--color">
    <div class="container">
      <div class="section__2">
        <h2 class="section__2__heading">Sinhala Book Collection</h2>
        <div class="component_container">
          <?php while ($book = $result->fetch_assoc()): ?>
            <div class="component">
              <h3 class="component__heading"><?php echo htmlspecialchars($book['title'] ?? ''); ?></h3>
              <img class="room-image" src="../Assets/images/sinhala/<?php echo htmlspecialchars($book['image_url'] ?? 'default.jpg'); ?>" alt="Book Image">
